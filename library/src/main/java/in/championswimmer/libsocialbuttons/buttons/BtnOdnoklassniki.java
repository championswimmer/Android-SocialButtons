 ...
 */
public class BtnOdnoklassniki extends AppCompatButton {
    public BtnOdnoklassniki(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.odnoklassniki);
        Drawable logo = getResources().getDrawable(R.drawable.logo_odnoklassniki);
