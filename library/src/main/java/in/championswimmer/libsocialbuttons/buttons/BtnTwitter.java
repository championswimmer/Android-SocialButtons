 ...
 */
public class BtnTwitter extends AppCompatButton {
    public BtnTwitter(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.twitter);
        Drawable logo = getResources().getDrawable(R.drawable.logo_twitter);
