 ...
 */
public class BtnYoutube extends AppCompatButton {
    public BtnYoutube(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.youtube);
        Drawable logo = getResources().getDrawable(R.drawable.logo_youtube);
