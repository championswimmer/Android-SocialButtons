 ...
 */
public class BtnQuora extends AppCompatButton {
    public BtnQuora(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.quora);
        Drawable logo = getResources().getDrawable(R.drawable.logo_quora);
