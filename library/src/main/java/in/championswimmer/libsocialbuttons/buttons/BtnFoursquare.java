 ...
 */
public class BtnFoursquare extends AppCompatButton {
    public BtnFoursquare(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.foursquare);
        Drawable logo = getResources().getDrawable(R.drawable.logo_foursquare);
