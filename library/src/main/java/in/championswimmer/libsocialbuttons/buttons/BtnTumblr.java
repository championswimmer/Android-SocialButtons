 ...
 */
public class BtnTumblr extends AppCompatButton {
    public BtnTumblr(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.tumblr);
        Drawable logo = getResources().getDrawable(R.drawable.logo_tumblr);
