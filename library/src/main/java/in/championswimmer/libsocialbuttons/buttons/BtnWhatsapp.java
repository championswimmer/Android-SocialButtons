 ...
 */
public class BtnWhatsapp extends AppCompatButton {
    public BtnWhatsapp(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.whatsapp);
        Drawable logo = getResources().getDrawable(R.drawable.logo_whatsapp);
