 ...
 */
public class BtnPinterest extends AppCompatButton {
    public BtnPinterest(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.pinterest);
        Drawable logo = getResources().getDrawable(R.drawable.logo_pinterest);
