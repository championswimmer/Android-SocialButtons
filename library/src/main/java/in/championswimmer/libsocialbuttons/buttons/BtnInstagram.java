 ...
 */
public class BtnInstagram extends AppCompatButton {
    public BtnInstagram(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.instagram);
        Drawable logo = getResources().getDrawable(R.drawable.logo_instagram);
