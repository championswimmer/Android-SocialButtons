 ...
 */
public class BtnGoogleplus extends AppCompatButton {
    public BtnGoogleplus(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.googleplus);
        Drawable logo = getResources().getDrawable(R.drawable.logo_google);
