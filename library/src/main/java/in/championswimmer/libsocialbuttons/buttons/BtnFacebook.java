 ...
 */
public class BtnFacebook extends AppCompatButton {
    public BtnFacebook(Context context, AttributeSet attrs) {
        super(context, attrs);

        int colorNormal = getResources().getColor(R.color.facebook);
        Drawable logo = getResources().getDrawable(R.drawable.logo_facebook);
