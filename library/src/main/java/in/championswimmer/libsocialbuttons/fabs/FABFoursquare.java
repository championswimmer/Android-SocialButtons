 ...
 */
public class FABFoursquare extends FloatingActionButton {
    public FABFoursquare(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setImageResource(R.drawable.logo_foursquare);
    }
}
