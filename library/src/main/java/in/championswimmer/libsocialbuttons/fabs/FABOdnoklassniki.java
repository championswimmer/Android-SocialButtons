 ...
 */
public class FABOdnoklassniki extends FloatingActionButton {
    public FABOdnoklassniki(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setImageResource(R.drawable.logo_odnoklassniki);
    }
}
