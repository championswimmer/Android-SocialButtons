 ...
 */
public class FABPinterest extends FloatingActionButton {
    public FABPinterest(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setImageResource(R.drawable.logo_pinterest);
    }
}
